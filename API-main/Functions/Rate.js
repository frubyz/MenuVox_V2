...
function rate(req, res, localPath) {
    ...
    if (!fs_1.default.existsSync(localPath + "rates/".concat(month, "/").concat(day, ".json"))) {
        if (!fs_1.default.existsSync(localPath + "rates/".concat(month))) {
            fs_1.default.mkdirSync(localPath + "rates/".concat(month));
        }
        fs_1.default.writeFileSync(localPath + "rates/".concat(month, "/").concat(day, ".json"), JSON.stringify([]));
    }
    var r = req.body.rate;
    ...
    if (menu === null || menu === void 0 ? void 0 : menu.error) {
    ...
    var MenuDate = new Date(date[2], date[1] - 1, date[0], 11, 45, 0);
    ...
    fs_1.default.writeFileSync(localPath + "rates/".concat(month, "/").concat(day, ".json"), JSON.stringify(Rates));
}
